...
function showQuetions(index){
    questionEl.innerText = questions4[index].numb + ". " + questions4[index].question
    a_text.innerText = questions4[index].options[0]
    b_text.innerText = questions4[index].options[1]
    c_text.innerText = questions4[index].options[2]
    d_text.innerText = questions4[index].options[3]
...
next_btn.onclick = ()=>{
    if(ketqua() == questions4[que_count].answer){
        userScore++;
    }
    deselectAnswers()
