...
function showQuetions(index){
    questionEl.innerText = questions3[index].numb + ". " + questions3[index].question
    a_text.innerText = questions3[index].options[0]
    b_text.innerText = questions3[index].options[1]
    c_text.innerText = questions3[index].options[2]
    d_text.innerText = questions3[index].options[3]
...
next_btn.onclick = ()=>{
    if(ketqua() == questions3[que_count].answer){
        userScore++;
    }
    deselectAnswers()
